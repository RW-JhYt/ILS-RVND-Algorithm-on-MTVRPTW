...
{                       XML Data Binding                       }
{                                                              }
{         Generated on: 16/06/2022 22:59:15                    }
{       Generated from: C:\Users\MSII\Downloads\C101_025.xml   }
{   Settings stored in: C:\Users\MSII\Downloads\C101_025.xdb   }
{                                                              }
{**************************************************************}
...
{ IXMLInstanceType }
  ...
  IXMLInstanceType = interface(IXMLNode)
    ['{41CF414C-7904-4F55-A2CE-C1B1575AE638}']
    { Property Accessors }
...
{ IXMLInfoType }
  ...
  IXMLInfoType = interface(IXMLNode)
    ['{AF1C1BBF-4118-4FF9-BE00-FB81C475FEED}']
    { Property Accessors }
...
{ IXMLNetworkType }
  ...
  IXMLNetworkType = interface(IXMLNode)
    ['{C75EA045-AC36-4E67-BAD4-BD18365D4CB3}']
    { Property Accessors }
...
{ IXMLNodesType }
  ...
  IXMLNodesType = interface(IXMLNodeCollection)
    ['{8D31FEA5-B7D1-4BB0-98CC-A3988A3A777F}']
    { Property Accessors }
...
{ IXMLNodeType }
  ...
  IXMLNodeType = interface(IXMLNode)
    ['{9659B54A-149E-4369-AD2D-E404B7DF1771}']
    { Property Accessors }
...
{ IXMLFleetType }
  ...
  IXMLFleetType = interface(IXMLNode)
    ['{C8742883-3264-40FF-8EC8-A0CF131C32A7}']
    { Property Accessors }
...
{ IXMLVehicle_profileType }
  ...
  IXMLVehicle_profileType = interface(IXMLNode)
    ['{CB8527EA-7530-4E09-B128-61AB4D7E54A2}']
    { Property Accessors }
    function Get_Type_: Integer;
...
{ IXMLRequestsType }
  ...
  IXMLRequestsType = interface(IXMLNodeCollection)
    ['{E6C15297-7F96-4C92-8D7D-8BFBE21C6C69}']
    { Property Accessors }
...
{ IXMLRequestType }
  ...
  IXMLRequestType = interface(IXMLNode)
    ['{53660D88-AFBB-40D3-8083-3547317F8057}']
    { Property Accessors }
    function Get_Id: Integer;
...
{ IXMLTwType }
  ...
  IXMLTwType = interface(IXMLNode)
    ['{0455C447-7245-4158-B4B3-24F9593EB9DB}']
    { Property Accessors }
